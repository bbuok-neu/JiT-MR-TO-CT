...
class JiT_MRCT(nn.Module):
    """
    Just image Transformer for MR-to-CT synthesis.
    Input: concatenated [zt, mr] with 2 channels
    Output: CT image with 1 channel
    """
    def __init__(
        self,
        input_size=256,
        ...
        # time embed (no class embedding for conditional synthesis)
        self.t_embedder = TimestepEmbedder(hidden_size)

        # linear embed - 2 channels input
        ...
        # in-context tokens for conditioning
    ...
    def forward(self, x, t):
        ...
        for i, block in enumerate(self.blocks):
            ...
            if self.in_context_len > 0 and i == self.in_context_start:
                # Use time embedding as in-context token
...
JiT_MRCT_models = {
    ...
    'JiT-L/32': JiT_MRCT_L_32,
    'JiT-H/16': JiT_MRCT_H_16,
    'JiT-H/32': JiT_MRCT_H_32,
}
